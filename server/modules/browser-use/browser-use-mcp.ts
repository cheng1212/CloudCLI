...
const browserUseServerPort = process.env.SERVER_PORT || process.env.PORT || '3001';
const apiUrl = (process.env.CLOUDCLI_BROWSER_USE_API_URL || `http://127.0.0.1:${browserUseServerPort}/api/browser-use-mcp`).replace(/\/$/, '');
