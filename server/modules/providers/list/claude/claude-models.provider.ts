...
export const CLAUDE_PREDEFINED_MODELS: ProviderModelsDefinition = {
  // The upstream Claude subscription models (default/best/fable/sonnet/opus/
  // haiku/opusplan) were removed: without an active Claude membership they are
  // not runnable. Sessions route through the model library's custom ids
