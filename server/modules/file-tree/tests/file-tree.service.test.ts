...
function createFakeFileSystem(
  ...
  return {
    ...
    // Containment re-checks call this; the fake uses a lexical identity so
    // path expectations keep matching without a real filesystem.
    realpath: async (candidatePath: string): Promise<string> => candidatePath,
