...
const SESSION_ROW_COLUMNS =
  'session_id, provider, provider_session_id, project_path, jsonl_path, custom_name, model, effort, isArchived, isPinned, created_at, updated_at';
...
export const sessionsDb = {
  ...
  /** Loads full rows (jsonl_path included) for batch operations; missing ids are simply absent. */
  getSessionsByIds(sessionIds: string[]): SessionRow[] {
  ...
  /** Hard-deletes many session rows in one transaction; returns how many rows were removed. */
