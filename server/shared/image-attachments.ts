...
/** Import the shared data-root resolver for use in this module, and re-export
 * it so existing imports of `@/shared/image-attachments.js` still work. */
import { getGlobalImageAssetsDir } from '@/shared/data-root.js';
export { getGlobalImageAssetsDir };
