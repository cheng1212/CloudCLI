...
type SidebarContentProps = {
  ...
  onTogglePinConversation: (sessionId: string, isPinned: boolean) => void;
  ...
  onToggleBulkSessionSelected: (sessionId: string) => void;
  onBulkSetSelectedSessions: (sessionIds: string[], selected: boolean) => void;
  onRequestBulkDeleteConfirmation: () => void;
...
export default function SidebarContent({
  ...
  onToggleBulkSessionSelected,
  onBulkSetSelectedSessions,
  onRequestBulkDeleteConfirmation,
  editingSession,
  editingSessionName,
      ...
      <ScrollArea className="flex-1 overflow-y-auto overscroll-contain md:px-1.5 md:py-2">
        {showConversationSearch ? (
          ...
          <SidebarRecentConversations
            ...
            isBulkMode={isBulkSelectionMode}
            bulkSelectedSessionIds={bulkSelectedSessionIds}
            isBulkDeleteRunning={isBulkDeleteRunning}
            onEnterBulkMode={onEnterBulkSelectionMode}
            onExitBulkMode={onExitBulkSelectionMode}
            onToggleBulkSelected={onToggleBulkSessionSelected}
            onBulkSetSelected={onBulkSetSelectedSessions}
            onRequestBulkDelete={onRequestBulkDeleteConfirmation}
            t={t}
          />
        ) : searchMode === 'running' ? (
