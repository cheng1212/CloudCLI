...
function Sidebar({
  ...
  return (
    <>
        ...
        onCancelBulkDelete={() => setBulkDeleteConfirmation(null)}
        onConfirmBulkDelete={confirmBulkDeleteSessions}
      ...
      {isSidebarCollapsed ? (
        ...
        <SidebarContent
            ...
            isBulkDeleteRunning={isBulkDeleteRunning}
            onEnterBulkSelectionMode={enterBulkSelectionMode}
            onExitBulkSelectionMode={exitBulkSelectionMode}
            onToggleBulkSessionSelected={toggleBulkSessionSelected}
            onBulkSetSelectedSessions={bulkSetSelectedSessions}
            onRequestBulkDeleteConfirmation={requestBulkDeleteConfirmation}
