...
export function useChatSessionState({
  ...
  useEffect(() => {
    ...
    // A locally cached latest page is seeded first so the pane shows content
    // instantly while this server fetch (always issued) refreshes it.
    sessionStore.hydrateFromCache(selectedSessionId);
