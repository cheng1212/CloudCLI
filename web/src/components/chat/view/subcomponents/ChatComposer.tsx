...
export default function ChatComposer({
  ...
  return (
    <div className="chat-composer-shell relative flex-shrink-0 px-2 pb-2 pt-0 sm:px-4 sm:pb-4 md:px-4 md:pb-6">
      {/* Hidden file inputs backing the attach menu. The generic input accepts
          any file type; the image input limits to images so mobile browsers
          open the photo gallery instead of the document picker. */}
      <input
        ref={fileInputRef}
        type="file"
        multiple
        ...
        <PromptInputFooter>
          <PromptInputTools className="min-w-0">
            <ActionMenu
              ...
              size="icon"
              portal
              triggerClassName="h-8 w-8 [&_svg]:size-4"
              items={[
                {
                  key: 'attach-files',
                  label: t('input.attachFiles'),
                  description: t('input.attachFilesDescription', { defaultValue: 'Any file type' }),
                  icon: FileTextIcon,
                ...
                },
                {
                  ...
                  description: t('input.attachImagesDescription', { defaultValue: 'Photos / gallery' }),
                  icon: ImageIcon,
