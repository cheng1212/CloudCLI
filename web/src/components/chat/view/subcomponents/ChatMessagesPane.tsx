...
import SessionPlanButton from './SessionPlanButton';
...
interface ChatMessagesPaneProps {
  ...
  /** Plan-progress state derived from the session's latest TodoWrite call. */
  sessionTodos?: SessionTodoState | null;
  ...
  return (
    ...
    >
      {chatMessages.length > 0 && (
        <div className="pointer-events-none sticky right-4 top-3 z-10 mb-2 flex justify-end gap-2 sm:px-4">
          <div className="pointer-events-auto">
            <SessionPlanButton todos={sessionTodos} />
          </div>
          <div className="pointer-events-auto">
