import { BarChart3, Bell, Bot, Clock, GitBranch, Info, Key, ListChecks, Mic, MonitorPlay, Palette, Puzzle } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'crons', labelKey: 'mainTabs.crons', icon: Clock },
