...
export const api = {
  ...
  // Bulk archive/delete used by the sidebar bulk-manage mode. Per-id semantics
  // mirror deleteSession; unknown ids come back in `notFound` instead of failing.
  deleteSessionsBatch: (sessionIds, hardDelete = false) =>
    authenticatedFetch('/api/providers/sessions/batch-delete', {
      method: 'POST',
      body: JSON.stringify({
        sessionIds,
        force: hardDelete,
